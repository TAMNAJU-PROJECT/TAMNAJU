                            ...
                            switch (data['category']) {
                                ...
                                case 'SKY':
                                    ...
                                    switch (data['fcstValue']) {
                                        case '1':// 맑음
                                            sky.setAttribute('src', 'https://openweathermap.org/img/wn/01d@2x.png');
                                            break;

                                        case '3':// 구름 많음
                                            sky.setAttribute('src', 'https://openweathermap.org/img/wn/03d@2x.png');
                                            break;

                                        case '4':// 흐림
                                            sky.setAttribute('src', 'https://openweathermap.org/img/wn/04d@2x.png');
                                            break;
